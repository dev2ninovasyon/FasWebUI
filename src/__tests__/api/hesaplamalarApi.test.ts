...
describe('Hesaplamalar API', () => {
    ...
    it('covers high-volume read endpoints', async () => {
        ...
        const results = await Promise.all([
            ...
            getCekSenetReeskontIskontoOranlari('TLREF', 2025),
            ...
            getIliskiliTarafSiniflama(1, 2025, 2, 120, false),
            getIliskiliTarafSiniflamaOrnekFisler(1, 2025, 2, {}, 120, false),
            ...
            getVadeliBankaMevduatiManuelSiniflamaOrnekFisler(1, 2025, 2, {}, false),
