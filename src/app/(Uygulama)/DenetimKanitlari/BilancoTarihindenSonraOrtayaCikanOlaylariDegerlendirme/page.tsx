...
const BCrumb = [
  ...
  {
    to: "/DenetimKanitlari/BilancoTarihindenSonraOrtayaCikanOlaylariDegerlendirme",
...
const Page = () => {
  ...
  const controller = "BilancoTarihindenSonraOrtayaCikanOlaylariDegerlendirme";
  ...
  return (
    <>
      ...
      <PageContainer
        title="Bilanço Tarihinden Sonra Ortaya Çıkan Olayları Değerlendirme"
        description="this is Bilanço Tarihinden Sonra Ortaya Çıkan Olayları Değerlendirme"
      >
        <Box>
          <CalismaKagidiBelge
