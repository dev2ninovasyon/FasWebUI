...
const BCrumb = [
  ...
  {
    to: "/DenetimKanitlari/DigerKanitlar/DenetimCalismalarininSinirlandirilmasiniDegerlendirme",
...
const Page = () => {
  ...
  const controller = "DenetimCalismalarininSinirlandirilmasiniDegerlendirme";
  ...
  return (
    <>
      ...
      <PageContainer
        title="Denetim Çalışmalarının Sınırlandırılmasını Değerlendirme"
        description="this is Denetim Çalışmalarının Sınırlandırılmasını Değerlendirme"
      >
        <Box>
          <CalismaKagidiBelge
