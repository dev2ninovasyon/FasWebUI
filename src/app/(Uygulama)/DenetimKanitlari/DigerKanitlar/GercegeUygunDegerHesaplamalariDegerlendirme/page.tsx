...
const BCrumb = [
  ...
  {
    to: "/DenetimKanitlari/DigerKanitlar/GercegeUygunDegerHesaplamalariDegerlendirme",
...
const Page = () => {
  ...
  const controller = "GercegeUygunDegerHesaplamalariDegerlendirme";
  ...
  return (
    <>
      ...
      <PageContainer
        title="Gerçeğe Uygun Değer Hesaplamaları Değerlendirme"
        description="this is Gerçeğe Uygun Değer Hesaplamaları Değerlendirme"
      >
        <Box>
          <CalismaKagidiBelge
