...
import IhmalEdilenDuzeltmeCalismaKagidi from "@/app/(Uygulama)/components/CalismaKagitlari/IhmalEdilenDuzeltmeCalismaKagidi";
...
const BCrumb = [
  ...
  {
    to: "/DenetimKanitlari/DigerKanitlar/IhmalEdilenDuzeltme",
...
const Page = () => {
  ...
  const controller = "IhmalEdilenDuzeltme";
  ...
  return (
    <>
      <Breadcrumb title="İhmal Edilen Düzeltme" items={BCrumb}>
        <>
          <Grid
            container
            sx={{
      ...
      <PageContainer
        title="İhmal Edilen Düzeltme"
        description="this is İhmal Edilen Düzeltme"
      >
        <Box>
          <IhmalEdilenDuzeltmeCalismaKagidi
