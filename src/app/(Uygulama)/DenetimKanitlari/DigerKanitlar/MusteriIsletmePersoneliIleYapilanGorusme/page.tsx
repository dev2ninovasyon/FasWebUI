...
const BCrumb = [
  ...
  {
    to: "/DenetimKanitlari/DigerKanitlar/MusteriIsletmePersoneliIleYapilanGorusme",
...
const Page = () => {
  ...
  const controller = "MusteriIsletmePersoneliIleYapilanGorusme";
  ...
  return (
    <>
      ...
      <PageContainer
        title="Müşteri İşletme Personeli İle Yapılan Görüşme"
        description="this is Müşteri İşletme Personeli İle Yapılan Görüşme"
      >
        <Box>
          <CalismaKagidiBelge
