...
const BCrumb = [
  ...
  {
    to: "/DenetimKanitlari/DigerKanitlar/MusteriIsletmeYonetimiIleYapilanGorusme",
...
const Page = () => {
  ...
  const controller = "MusteriIsletmeYonetimiIleYapilanGorusme";
  const grupluMu = true;
  ...
  return (
    <>
      ...
      <PageContainer
        title="Müşteri İşletme Yönetimi İle Yapılan Görüşme"
        description="this is Müşteri İşletme Yönetimi İle Yapılan Görüşme"
      >
        <Box>
          <CalismaKagidiBelge
