...
const BCrumb = [
  ...
  {
    to: "/DenetimKanitlari/DigerKanitlar/RisklereKarsiUygulananDenetimProsedurleri",
...
const Page = () => {
  ...
  const controller = "RisklereKarsiUygulananDenetimProsedurleri";
  ...
  return (
    <>
      ...
      <PageContainer
        title="Risklere Karşı Uygulanan Denetim Prosedürleri"
        description="this is Risklere Karşı Uygulanan Denetim Prosedürleri"
      >
        <Box>
          <CalismaKagidiBelge
