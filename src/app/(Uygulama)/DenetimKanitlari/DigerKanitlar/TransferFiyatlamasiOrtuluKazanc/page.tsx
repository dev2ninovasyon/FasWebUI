...
const BCrumb = [
  ...
  {
    to: "/DenetimKanitlari/DigerKanitlar/TransferFiyatlamasiOrtuluKazanc",
...
const Page = () => {
  ...
  const controller = "TransferFiyatlamasiOrtuluKazanc";
  const grupluMu = true;
  ...
  return (
    <>
      ...
      <PageContainer
        title="Transfer Fiyatlaması ve Örtülü Kazanç Kontrol"
        description="this is Transfer Fiyatlaması ve Örtülü Kazanç Kontrol"
      >
        <Box>
          <CalismaKagidiBelge
