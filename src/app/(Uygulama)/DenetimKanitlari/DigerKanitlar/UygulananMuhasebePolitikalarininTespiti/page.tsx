...
const BCrumb = [
  ...
  {
    to: "/DenetimKanitlari/DigerKanitlar/UygulananMuhasebePolitikalarininTespiti",
...
const Page = () => {
  ...
  const controller = "UygulananMuhasebePolitikalarininTespiti";
  ...
  return (
    <>
      ...
      <PageContainer
        title="Uygulanan Muhasebe Politikalarının Tespiti"
        description="this is Uygulanan Muhasebe Politikalarının Tespiti"
      >
        <Box>
