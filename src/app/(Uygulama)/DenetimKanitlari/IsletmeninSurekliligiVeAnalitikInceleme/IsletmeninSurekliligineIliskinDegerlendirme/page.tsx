...
const BCrumb = [
  ...
  {
    to: "/DenetimKanitlari/IsletmeninSurekliliğiVeAnalitikInceleme/IsletmeninSurekliligineIliskinDegerlendirme",
...
const Page = () => {
  ...
  const controller = "IsletmeninSurekliligineIliskinDegerlendirme";
  ...
  return (
    <>
      ...
      <PageContainer
        title="İşletmenin Sürekliliğine İlişkin Değerlendirme"
        description="this is İşletmenin Sürekliliğine İlişkin Değerlendirme"
      >
        <Box>
          <CalismaKagidiBelge
