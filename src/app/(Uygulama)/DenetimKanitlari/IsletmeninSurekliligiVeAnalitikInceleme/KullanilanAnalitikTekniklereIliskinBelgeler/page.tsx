...
const BCrumb = [
  ...
  {
    to: "/DenetimKanitlari/IsletmeninSurekliliğiVeAnalitikInceleme/KullanilanAnalitikTekniklereIliskinBelgeler",
...
const Page = () => {
  ...
  const controller = "KullanilanAnalitikTekniklereIliskinBelgeler";
  ...
  return (
    <>
      ...
      <PageContainer
        title="Kullanılan Analitik Tekniklere İlişkin Belgeler"
        description="this is Kullanılan Analitik Tekniklere İlişkin Belgeler"
      >
        <Box>
          <CalismaKagidiBelge
