...
const BCrumb = [
  ...
  {
    to: "/DenetimKanitlari/IsletmeninSurekliliğiVeAnalitikInceleme/OnemliSureclerinIzlenmesiVeRiskBelirleme",
...
const Page = () => {
  ...
  const controller = "OnemliSureclerinIzlenmesiVeRiskBelirleme";
  ...
  return (
    <>
      ...
      <PageContainer
        title="Önemli Süreçlerin İzlenmesi ve Risk Belirleme"
        description="this is Önemli Süreçlerin İzlenmesi ve Risk Belirleme"
      >
        <Box>
          <CalismaKagidiBelge
