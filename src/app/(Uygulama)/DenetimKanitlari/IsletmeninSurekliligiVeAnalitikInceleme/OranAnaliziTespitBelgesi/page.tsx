...
const BCrumb = [
  ...
  {
    to: "/DenetimKanitlari/IsletmeninSurekliliğiVeAnalitikInceleme/OranAnaliziTespitBelgesi",
...
const Page = () => {
  ...
  const handleHesapla = async () => {
    try {
      ...
      if (result) {
        ...
        enqueueSnackbar("Oran Analizi Tespit Belgesi Oluşturuldu", {
          variant: "success",
        ...
        enqueueSnackbar("Oran Analizi Tespit Belgesi Oluşturulamadı", {
          variant: "error",
          autoHideDuration: 5000,
          style: {
            backgroundColor:
  ...
  return (
    <PageContainer title="Oran Analizi Tespit Belgesi" description="this is Oran Analizi Tespit Belgesi">
      <Breadcrumb title="Oran Analizi Tespit Belgesi" items={BCrumb}>
        <EkBelgeYukleButton formKodu="OranAnaliziTespitBelgesi" />
      </Breadcrumb>
      <Grid container>
        <Grid
