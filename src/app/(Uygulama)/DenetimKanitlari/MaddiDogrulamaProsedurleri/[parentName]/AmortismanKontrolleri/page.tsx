...
const Page = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                setIsSearching(true);
                // Try to find "Amortisman Kontrolleri" or default to "05"
                // Since "Amortisman Kontrolleri" might not be in the dipnot list with that exact name,
                // we might need to rely on the user navigating here or default logic.
                // For now, let's try to fetch it, if not found, use "05".
    ...
    const BCrumbList = [
        ...
        { title: "Amortisman Kontrolleri" },
    ];

    return (
        <PageContainer title="Amortisman Kontrolleri" description="Amortisman Kontrolleri">
            <Breadcrumb title="Amortisman Kontrolleri" items={BCrumbList} />
                ...
                <>
                    ...
                    <Box mt={3}>
                        <MaddiDogrulamaYorumComponent
                            ...
                            childName="AmortismanKontrolleri"
                        />
                    </Box>
                </>
            ) : (
