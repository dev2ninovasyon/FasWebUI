...
const Page = () => {
    ...
    const documentTitle = searchParams.get('title') || "Envanter Kontrolleri";
    ...
    const BCrumbList = useMemo(() => {
        return [
            ...
            { to: currentPath, title: "Envanter Kontrolleri" },
        ];
    ...
    return (
        <PageContainer title="Envanter Kontrolleri" description="Envanter Kontrolleri">
            <Breadcrumb title="" subtitle="Envanter Kontrolleri" items={BCrumbList}>
