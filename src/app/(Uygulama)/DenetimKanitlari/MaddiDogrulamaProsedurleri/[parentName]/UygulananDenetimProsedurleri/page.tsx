...
const Page = () => {
  ...
  const documentTitle = searchParams.get('title') || "Uygulanan Denetim Prosedürleri";
  ...
  const BCrumb = useMemo(() => {
    return [
      ...
      { to: currentPath, title: "Uygulanan Denetim Prosedürleri" },
    ];
  ...
  return (
    ...
    >
      <Breadcrumb
        title=""
        subtitle={`Uygulanan Denetim Prosedürleri`}
        items={BCrumb}
      >
        <>
          <Grid
