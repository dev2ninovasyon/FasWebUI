...
import DogrulamaMektuplarinaAlinanYanitlarBelge from "@/app/(Uygulama)/components/CalismaKagitlari/DogrulamaMektuplarinaAlinanYanitlarBelge";
...
const Page = () => {
  ...
  return (
    <>
      ...
      >
        <Box>
          <DogrulamaMektuplarinaAlinanYanitlarBelge
