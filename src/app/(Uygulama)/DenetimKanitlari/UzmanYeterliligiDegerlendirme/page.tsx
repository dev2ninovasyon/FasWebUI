...
const BCrumb = [
  ...
  {
    to: "/DenetimKanitlari/UzmanYeterliligiDegerlendirme",
    title: "Uzman Yeterliliği Değerlendirme",
  },
];
...
const Page = () => {
  ...
  const controller = "UzmanYeterliligiDegerlendirme";
  ...
  return (
    <>
      <Breadcrumb title="Uzman Yeterliliği Değerlendirme" items={BCrumb}>
        <>
          <Grid
            container
            sx={{
      ...
      <PageContainer
        title="Uzman Yeterliliği Değerlendirme"
        description="this is Uzman Yeterliliği Değerlendirme"
      >
        <Box>
          <CalismaKagidiBelge
