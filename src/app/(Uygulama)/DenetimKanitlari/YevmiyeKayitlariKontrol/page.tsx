...
const BCrumb = [
  ...
  {
    to: "/DenetimKanitlari/DigerKanitlar/YevmiyeKayitlariKontrol",
...
const Page = () => {
  ...
  const controller = "YevmiyeKayitlariKontrol";
  ...
  return (
    <>
      <Breadcrumb title="Yevmiye Kayıtları Kontrol" items={BCrumb}>
        <>
          <Grid
            container
            sx={{
      ...
      <PageContainer
        title="Yevmiye Kayıtları Kontrol"
        description="this is Yevmiye Kayıtları Kontrol"
      >
        <Box>
          <CalismaKagidiBelge
