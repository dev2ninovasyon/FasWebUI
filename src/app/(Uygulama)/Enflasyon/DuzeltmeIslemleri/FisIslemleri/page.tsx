    ...
    <PageContainer title="Fiş İşlemleri" description="this is Fiş İşlemleri">
      ...
      <Grid container spacing={3}>
        <Grid item xs={12} sm={12} lg={12}>
          <iframe
            src={`https://93.89.73.135//EnflasyonDuzeltmesi/FisIslemleri?username=${user.kullaniciAdi}&denetciId=${user.denetciId}&kullaniciId=${user.id}&denetlenenId=${user.denetlenenId}&yil=${user.yil}`}
            style={{
              border: "0px",
              width: "100%",
              height: 700,
