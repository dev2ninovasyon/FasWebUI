...
const BCrumb = [
    ...
    {
        to: "/Enflasyon/DuzeltmeIslemleri/IptalFisi",
        title: "İptal Fişi",
    },
];
...
const Page: React.FC = () => {
    ...
    return (
        <ProtectedPage allowed={user?.enflasyonmu || false}>
            <PageContainer
                title="İptal Fişi"
                description="this is İptal Fişi"
            >
                <Breadcrumb title="İptal Fişi" items={BCrumb} />
                <Grid container spacing={3} sx={{ height: "calc(100vh - 225px)", overflow: "hidden" }}>
                    <Grid
                        ...
                        <EnflasyonIframe url="/EnflasyonDuzeltmesi/IptalFisi" />
                    </Grid>
                </Grid>
            </PageContainer>
        </ProtectedPage>
