      ...
      >
        ...
        <Grid container spacing={3}>
          <Grid
            ...
            <iframe
              src={`${ENFLASYON_BASE_URL}/EnflasyonDuzeltmesi/FinansmanMaliyeti?username=${user.kullaniciAdi}&denetciId=${user.denetciId}&kullaniciId=${user.id}&denetlenenId=${user.denetlenenId}&yil=${user.yil}`}
              style={{
                border: "0px",
                width: "100%",
                height: 700,
