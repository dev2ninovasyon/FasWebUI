...
interface Veri {
  ...
  odenmemeOrani: number;
  yaslandirmaAlacakBakiye: number;
  bakiyeCarpiOdenmemeOrani: number;
  revizeEdilmisOran: number;
  beklenenKZ: number;
  beklenenKZBugunkiDeger: number;
}

interface Props {
  hesaplaTiklandimi: boolean;
}
const BeklenenKrediZarari: React.FC<Props> = ({ hesaplaTiklandimi }) => {
  ...
  const colHeaders = [
    ...
    "Beklenen Kredi Zararı Bugünki Değer",
  ];
  ...
  const fetchData = async () => {
    try {
      ...
      const rowsAll: any = [];
      beklenenKrediZarariVerileri.forEach((veri: any) => {
        const newRow: any = [
          veri.hesap,
          veri.vade,
          veri.toplamAlacaklar,
          veri.odenmemeOrani,
          veri.yaslandirmaAlacakBakiye,
          veri.bakiyeCarpiOdenmemeOrani,
          veri.revizeEdilmisOran,
          veri.beklenenKZ,
          veri.beklenenKZBugunkiDeger,
        ];
        rowsAll.push(newRow);
      });
  ...
  const handleDownload = () => {
    ...
    async function createExcelFile() {
      ...
      try {
        ...
        saveAs(blob, "BeklenenKrediZarariHesaplama.xlsx");
