...
import { getVergiYukumlulugu } from "@/api/Hesaplamalar/Hesaplamalar";
...
const VergiYukumluluk: React.FC<Props> = ({ hesaplaTiklandimi }) => {
  ...
  const fetchData = async () => {
    try {
      ...
      vergiVarligiVerileri.forEach((veri: any) => {
        const newRow: any = [
          veri.hesapAdi,
          veri.geciciFarkYukumluluk,
          veri.ertelenenVergiYukumlulugu,
        ];
        rowsAll.push(newRow);
      });
