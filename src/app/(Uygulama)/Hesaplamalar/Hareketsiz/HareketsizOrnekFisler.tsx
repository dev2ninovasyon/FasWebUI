...
const HareketsizOrnekFisler: React.FC<Props> = ({
  hesaplaTiklandimi,
  tip,
  kaydetTiklandimi,
  setkaydetTiklandimi,
  ...
  const fetchData = async () => {
    try {
      if (tip == "TicariAlacaklar") {
        ...
        const rowsAll: any = [];
        hareketsizTicariAlacaklarOrnekFisVerileri.forEach((veri: any) => {
          const newRow: any = [
            true,
            veri.yevmiyeNo,
            veri.fisTipi,
      ...
      if (tip == "Stoklar") {
        ...
        const rowsAll: any = [];
        hareketsizStoklarOrnekFisVerileri.forEach((veri: any) => {
          const newRow: any = [
            true,
            veri.yevmiyeNo,
            veri.fisTipi,
