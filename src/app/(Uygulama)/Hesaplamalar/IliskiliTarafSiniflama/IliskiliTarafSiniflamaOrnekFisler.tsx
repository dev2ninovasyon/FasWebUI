...
import { getIliskiliTarafSiniflamaOrnekFisler } from "@/api/Hesaplamalar/Hesaplamalar";
...
const IliskiliTarafSiniflamaOrnekFisler: React.FC<Props> = ({
  json,
  hesap,
  kaydetTiklandimi,
  setkaydetTiklandimi,
  ...
  const fetchData = async () => {
    try {
      if (json) {
        ...
        const rowsAll: any = [];
        iliskiliTarafSiniflamaOrnekFisVerileri.forEach((veri: any) => {
          const newRow: any = [
            true,
            veri.yevmiyeNo,
            veri.fisTipi,
