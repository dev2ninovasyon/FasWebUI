...
import { getDovizKurlariOtuzBirAralik } from "@/api/Hesaplamalar/Hesaplamalar";
...
const DovizKurlariOtuzBirAralik = () => {
  ...
  const colHeaders = ["Para Birimi", "Tarih", "Döviz Alış", "Döviz Satış"];
  ...
  const fetchData = async () => {
    try {
      ...
      dovizKurlariOtuzBirAralik.forEach((veri: any) => {
        if (veri.tarih.split("T")[0].split("-")[0] == user.yil) {
          const newRow: any = [
            veri.paraBirimiAdi,
