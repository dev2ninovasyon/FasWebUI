...
import { getVadeliBankaMevduatiOtomatikSiniflamaOrnekFisler } from "@/api/Hesaplamalar/Hesaplamalar";
...
const VadeliBankaMevduatiOtomatikSiniflamaOrnekFisler: React.FC<Props> = ({
  hesaplaTiklandimi,
  kaydetTiklandimi,
  setkaydetTiklandimi,
}) => {
  ...
  const fetchData = async () => {
    try {
      ...
      const rowsAll: any = [];
      vadeliBankaMevduatiOtomatikSiniflamaOrnekFisVerileri.forEach(
        (veri: any) => {
          const newRow: any = [
            true,
            veri.yevmiyeNo,
  ...
  const handleDownload = () => {
    ...
    async function createExcelFile() {
      ...
      try {
        ...
        saveAs(blob, `VadeliBankaMevduatiOtomatikSiniflamaOrnekFisler.xlsx`);
