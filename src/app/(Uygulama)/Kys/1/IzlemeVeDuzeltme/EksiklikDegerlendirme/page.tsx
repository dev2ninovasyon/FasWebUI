...
const BCrumb = [
    ...
    { to: "/Kys/1/IzlemeVeDuzeltme/EksiklikDegerlendirme", title: "9.7 Eksiklik Değerlendirme Çalışma Sayfası" },
];
        ...
        <PageContainer title="9.7 Eksiklik Değerlendirme Çalışma Sayfası" description="Eksiklik Değerlendirme Çalışma Sayfası">
            ...
            <Box sx={{ mt: 3 }}>
                <Typography variant="h4" sx={{ mb: 3, color: "#1976d2", fontWeight: 600 }}>
                    9.7 EKSİKLİK DEĞERLENDİRME ÇALIŞMA SAYFASI
                </Typography>
                <KysBelgeEditor formKodu="KysEksiklikDegerlendirme" />
            </Box>
        </PageContainer>
    );
};
