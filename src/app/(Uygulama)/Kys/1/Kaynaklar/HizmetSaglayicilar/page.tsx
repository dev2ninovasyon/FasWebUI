...
const BCrumb = [
  ...
  {
    to: "/Kys/1/Kaynaklar/HizmetSaglayicilar",
    title: "Teknolojik, Entelektüel Kaynaklar ve Hizmet Sağlayacılar",
  },
];
...
const Page = () => {
  ...
  const controller = "HizmetSaglayicilar";
  ...
  return (
    <>
      ...
      <PageContainer
        title="Teknolojik, Entelektüel Kaynaklar ve Hizmet Sağlayacılar"
        description="this is Teknolojik, Entelektüel Kaynaklar ve Hizmet Sağlayacılar"
      >
        <Box>
          <CalismaKagidiBelge
