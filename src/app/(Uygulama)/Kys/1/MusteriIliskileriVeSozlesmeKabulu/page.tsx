...
const BCrumb = [
  ...
  {
    to: "/Kys/1/MusteriIliskileriVeSozlesmeKabulu",
    title:
...
const Page = () => {
  ...
  const controller = "RiskBelirleme";
  ...
  return (
    <>
      ...
      <PageContainer
        title="Müşteri İlişkisinin ve Belirli BirSözleşmenin Kabulü ve Devam Ettirilmesi"
        description="this is 	Müşteri İlişkisinin ve Belirli BirSözleşmenin Kabulü ve Devam Ettirilmesi"
      >
        <Box>
          <CalismaKagidiBelge
