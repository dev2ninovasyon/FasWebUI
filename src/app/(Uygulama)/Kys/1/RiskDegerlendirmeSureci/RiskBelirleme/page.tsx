...
const BCrumb = [
  ...
  {
    to: "/Kys/1/RiskDegerlendirmeSureci/RiskBelirleme",
...
const Page = () => {
  ...
  return (
    <>
      <Breadcrumb title="Risk Belirleme" items={BCrumb}>
        <>
          <Grid
            container
            sx={{
      ...
      <PageContainer title="RiskBelirleme" description="this is RiskBelirleme">
        <Box>
          <CalismaKagidiBelge
