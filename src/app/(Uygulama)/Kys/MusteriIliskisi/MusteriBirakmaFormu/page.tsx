...
import KysCalismaKagidiTable from "@/app/(Uygulama)/components/Kys/KysCalismaKagidiTable";
    ...
    return (
        <PageContainer title="5.7 Müşteri Bırakma Formu" description="Müşteri Bırakma Formu">
            ...
            <Box sx={{ mt: 3 }}>
                ...
                <KysCalismaKagidiTable formKodu="KysMusteriBirakmaFormu" alanAdi="5.7 Müşteri Bırakma Formu" />
            </Box>
        </PageContainer>
    );
};
