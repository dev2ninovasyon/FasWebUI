...
const BCrumb = [
  ...
  {
    to: "/Musteri/IsletmeFaaliyetVeCevresiTanima",
...
const Page = () => {
  ...
  const controller = "IsletmeFaaliyetveCevreTanima";
  const grupluMu = true;
  ...
  return (
    <>
      <Breadcrumb title="İşletme Faaliyet ve Çevresi Tanıma" items={BCrumb}>
        <>
          <Grid
            container
            sx={{
      ...
      <PageContainer
        title="İşletme Faaliyet ve Çevresi Tanıma"
        description="this is İşletme Faaliyet ve Çevresi Tanıma"
      >
        <Box>
          <CalismaKagidiBelge
