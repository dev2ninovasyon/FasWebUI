...
const BCrumb = [
  ...
  {
    to: "/Musteri/MusteriDurustlugunuDegerlendirme",
...
const Page = () => {
  ...
  const controller = "MusteriDurustlugunuDegerlendirme";
  ...
  return (
    <>
      <Breadcrumb title="Müşteri Dürüstlüğünü Değerlendirme" items={BCrumb}>
        <>
          <Grid
            container
            sx={{
      ...
      <PageContainer
        title="Müşteri Dürüstlüğünü Değerlendirme"
        description="this is Müşteri Dürüstlüğünü Değerlendirme"
      >
        <Box>
          <CalismaKagidiBelge
