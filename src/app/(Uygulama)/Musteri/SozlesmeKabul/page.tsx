...
const BCrumb = [
  ...
  {
    to: "/Musteri/SozlesmeKabul",
    title: "Sözleşme Kabul",
  },
];
...
const Page = () => {
  ...
  const controller = "SozlesmeKabul";
  ...
  return (
    <>
      <Breadcrumb title="Sözleşme Kabul" items={BCrumb}>
        <>
          <Grid
            container
            sx={{
      ...
      <PageContainer
        title="Sözleşme Kabul"
        description="this is Sözleşme Kabul"
      >
        <Box>
          <CalismaKagidiBelge
