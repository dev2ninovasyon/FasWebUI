...
const BulguRiskiBelirleme: React.FC<Props> = ({ hesaplaTiklandimi }) => {
  ...
  const fetchData = async () => {
    try {
      ...
      if (bulguRiskiBelirlemeVerileri) {
        const rowsAll: any = [];

        const newRow: any = [
          bulguRiskiBelirlemeVerileri.dogalRisk,
          bulguRiskiBelirlemeVerileri.kontrolRiski,
          bulguRiskiBelirlemeVerileri.girilenRisk,
          bulguRiskiBelirlemeVerileri.bulguRiski,
        ];
        rowsAll.push(newRow);
