...
const Page = () => {
  ...
  return (
    <>
      <Breadcrumb title="Genel Bağımsız Denetim Planı" items={BCrumb}>
        <>
          <Grid
            container
            sx={{
      ...
      <PageContainer
        title="Genel Bağımsız Denetim Planı"
        description="this is Genel Bağımsız Denetim Planı"
      >
        <Box>
