...
const BCrumb = [
  ...
  {
    to: "/PlanVeProgram/DenetimRiskDegerlendirme",
...
const Page = () => {
  ...
  const controller = "DenetimRiskDegerlendirme";
  ...
  return (
    <>
      <Breadcrumb title="Denetim Risk Değerlendirme" items={BCrumb}>
        <>
          <Grid
            container
            sx={{
      ...
      <PageContainer
        title="Denetim Risk Değerlendirme"
        description="this is Denetim Risk Değerlendirme"
      >
        <Box>
          <CalismaKagidiBelge
