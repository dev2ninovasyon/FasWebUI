...
const BCrumb = [
  ...
  {
    to: "/PlanVeProgram/DenetimZamaniBildirme",
...
const Page = () => {
  ...
  const controller = "DenetimZamaniBildirme";
  ...
  return (
    <>
      <Breadcrumb title="Denetim Zamanı Bildirme" items={BCrumb}>
        <>
          <Grid
            container
            sx={{
      ...
      <PageContainer
        title="Denetim Zamanı Bildirme"
        description="this is Denetim Zamanı Bildirme"
      >
        <Box>
