...
const BCrumb = [
  ...
  {
    to: "/PlanVeProgram/DenetlenenIsletmeninTabiOlduguMevzuataIliskinDegerlendirme",
    title: "Denetlenen İşletmenin Tabi Olduğu Mevzuata İlişkin Değerlendirme",
  },
];
...
const Page = () => {
  ...
  return (
    <>
      ...
      <PageContainer
        title="Denetlenen İşletmenin Tabi Olduğu Mevzuata İlişkin Değerlendirme"
        description="this is Denetlenen İşletmenin Tabi Olduğu Mevzuata İlişkin Değerlendirme"
      >
        <Box>
          <CalismaKagidiBelge
