...
const BCrumb = [
  ...
  {
    to: "/Surdurulebilirlik/SurdurulebilirlikGenelBilgiler",
    title: "Sürdürülebilirlik Genel Bilgiler",
  },
];
...
const Page = () => {
  ...
  const controller = "SurdurulebilirlikGenelBilgiler";
  ...
  return (
    <>
      <Breadcrumb title="Sürdürülebilirlik Genel Bilgiler" items={BCrumb}>
        <>
          <Grid
            container
            sx={{
      ...
      <PageContainer
        title="Sürdürülebilirlik Genel Bilgiler"
        description="Sürdürülebilirlik Genel Bilgiler"
      >
        <Box>
