...
const BCrumb = [
  ...
  {
    to: "/Surdurulebilirlik/SurdurulebilirlikKurumsalYonetisim",
    title: "Sürdürülebilirlik Kurumsal Yonetisim",
  },
];
...
const Page = () => {
  ...
  const controller = "SurdurulebilirlikKurumsalYonetisim";
  const grupluMu = false;
  const alanAdi1 = "İşlem";
  const alanAdi2 = "Tespitler";
...
{isMobile ? (
      ...
      <PageContainer
        ...
        description="this is Hile Usulsüzlük ve Risk Faktörleri Değerlendirme"
      >
        <Box>
          <CalismaKagidiBelge
