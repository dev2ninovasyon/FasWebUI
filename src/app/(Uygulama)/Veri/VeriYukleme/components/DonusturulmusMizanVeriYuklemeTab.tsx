...
import DonusturulmusMizan from "@/app/(Uygulama)/Veri/DonusturulmusMizanVeriYukleme/DonusturulmusMizan";
...
const DonusturulmusMizanVeriYuklemeTab: React.FC = () => {
...
export default DonusturulmusMizanVeriYuklemeTab;
