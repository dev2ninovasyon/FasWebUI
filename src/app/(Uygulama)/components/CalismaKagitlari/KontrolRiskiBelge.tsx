...
const KontrolRiskiBelge: React.FC<CalismaKagidiProps> = ({
  refresh,
  controller,
  grupluMu,
  ...
  const [selectedGroupKonu, setSelectedGroupKonu] = useState("");
  ...
  const handleGroupClick = (veri: any) => {
    ...
    setSelectedGroupKonu(veri.konu);
  };
  ...
  return (
    <>
      ...
      {isGroupPopUpOpen && (
        <DuzenleGroupPopUp
          islem={selectedGroupKonu}
          setIslem={setSelectedGroupKonu}
...
export default KontrolRiskiBelge;
          ...
          <DialogContent>
            <Box px={3} pt={3}>
              ...
              <CustomSelect
                ...
                sx={{ width: "100%" }}
              >
                <MenuItem value={"Risksiz"}>Risksiz</MenuItem>
                <MenuItem value={"Az Riskli"}>Az Riskli</MenuItem>
                <MenuItem value={"Riskli"}>Riskli</MenuItem>
                <MenuItem value={"Yüksek Riskli"}>Yüksek Riskli</MenuItem>
              </CustomSelect>
            </Box>
            <Box px={3} pt={3}>
              <Typography variant="h5" p={1}>
