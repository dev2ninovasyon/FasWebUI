...
import { getDikeyAnalizTablosuKarZarar } from "@/api/Analizler/Analizler";
...
const GelirDegerlendirmeBelgesi: React.FC<Props> = ({
  showGraph,
  hesaplaTiklandimi,
}) => {
...
const controller = "GelirDegerlendirmeBelgesi";
