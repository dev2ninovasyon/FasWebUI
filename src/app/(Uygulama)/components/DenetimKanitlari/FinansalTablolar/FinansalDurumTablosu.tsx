...
import FinansalDurumTablosuCardTable from "@/app/(Uygulama)/components/DenetimKanitlari/FinansalTablolar/FinansalDurumTablosuCardTable";
import AktifPasifCardTable from "@/app/(Uygulama)/components/DenetimKanitlari/FinansalTablolar/AktifPasifCardTable";
import KarZararCardTable from "@/app/(Uygulama)/components/DenetimKanitlari/FinansalTablolar/KarZararTablosuCardTable";
import {
...
const FinansalDurumTablosu: React.FC<Props> = ({ konsolidasyonMu = false }) => {
  ...
  const [detayTiklandimi, setDetayTiklandimi] = React.useState<boolean>(false);
  ...
  const fetchData = async () => {
    try {
      ...
      setTitle(finansalDurumTablosu[0]?.kalemAdi);
      ...
      const newRowsKzt = karZararTablosu.slice(1).map((veri: Veri) => ({
        id: veri.id,
        parentId:
          veri.parentId !== undefined
    ...
    <Grid container>
      <Grid item xs={12} lg={12}>
        <AktifPasifCardTable
          ...
          setDetayTiklandimi={setDetayTiklandimi}
        />
