...
const OrneklemForm: React.FC<Props> = ({
  guvenilirlikDuzeyi,
  hataPayi,
  listelemeTuru,
    ...
    <div>
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} sm={3.5} lg={3.5} display="flex" alignItems="center">
          ...
          >
            <Typography variant="subtitle1">Listeleme Türü:</Typography>
          </CustomFormLabel>
          <CustomSelect
            labelId="listelemeTuru"
            id="listelemeTuru"
            size="small"
            value={listelemeTuru}
            fullWidth
            onChange={(e: any) => {
              setListelemeTuru(e.target.value);
            }}
            height="36px"
            sx={{ minWidth: 120 }}
          >
            <MenuItem value={"Aya Göre"}>Aya Göre</MenuItem>
            <MenuItem value={"Büyüklüğe Göre"}>Büyüklüğe Göre</MenuItem>
            <MenuItem value={"Satışa Göre"}>Satışa Göre</MenuItem>
            <MenuItem value={"Rastgele"}>Rastgele</MenuItem>
          </CustomSelect>
        </Grid>
