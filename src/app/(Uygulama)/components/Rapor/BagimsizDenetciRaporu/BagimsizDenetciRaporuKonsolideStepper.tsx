...
import { IconFileTypeDoc, IconX, IconEye, IconDownload, IconChevronDown } from "@tabler/icons-react";
import {
  getRaporDipnot,
  getRaporGorus,
  updateRaporGorus,
  ...
  return (
    <Box>
      ...
      <>
        ...
        <Box sx={{ display: "flex", flexDirection: "row", px: 1 }} className="no-print">
          <Button
            color="inherit"
        ...
        <style jsx global>{`
          @media print {
            ...
            * {
            ...
            /* Resimlerin düzgün yazdırılması */
            #logoImg, #kapakImg {
              display: block !important;
              visibility: visible !important;
            }
