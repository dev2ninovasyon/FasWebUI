...
const DovizKuruRiskiCari: React.FC<Props> = ({
  dipnotKodu,
  kaydetTiklandimi,
  setKaydetTiklandimi,
}) => {
  ...
  const handleSaveDoviKuruRiskiVerisi = async () => {
    const keys = [
      "denetciId",
      "denetlenenId",
      "yil",
    ...
    if (result) {
      console.log("Döviz Kuru Riski Cari güncellendi.");
    } else {
      console.log("Döviz Kuru Riski Cari güncellenemedi.");
    }
  };
  ...
  return (
    <>
      <HotTable
        ...
        columns={columns}
        colWidths={[120, 100, 100, 100, 100, 100, 100]}
        stretchH="all"
...
export default DovizKuruRiskiCari;
