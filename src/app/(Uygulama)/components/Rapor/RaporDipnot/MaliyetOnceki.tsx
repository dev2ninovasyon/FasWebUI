...
const MaliyetOnceki: React.FC<Props> = ({
  dipnotKodu,
  kaydetTiklandimi,
  setKaydetTiklandimi,
}) => {
  ...
  const handleSaveMaliyetVerisi = async () => {
    const keys = [
      "denetciId",
      "denetlenenId",
      "yil",
    ...
    if (result) {
      ...
      console.log("Dipnot Maliyet Önceki güncellenemedi.");
    }
  };
