...
import KurumlarVergisiBeyannamesiKarsilastirmaEnflasyonHaric from "@/app/(Uygulama)/components/Veri/Mizan/KurumlarVergisiBeyannamesiKarsilastirmaEnflasyonHaric";
