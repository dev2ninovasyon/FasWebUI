...
import { getKurumlarVergisiBeyannamesiKarsilastirma } from "@/api/Veri/Mizan";
...
const KurumlarVergisiBeyannamesiKarsilastirma: React.FC<Props> = ({ type }) => {
  ...
  return (
    <>
      <HotTable
        ...
        columns={columns}
        colWidths={[40, 120, 100, 100, 100, 100, 100]}
        stretchH="all"
