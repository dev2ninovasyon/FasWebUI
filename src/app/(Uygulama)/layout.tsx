...
const Sidebar = dynamic(() => import("./components/Layout/Vertical/Sidebar/Sidebar"), { ssr: false });
const Header = dynamic(() => import("./components/Layout/Vertical/Header/Header"), { ssr: false });
